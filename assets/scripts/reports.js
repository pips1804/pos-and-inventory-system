            ...
            <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
                <table class="table table-dark">
                    <thead class="table-dark">
                        <tr>
                            <th>#</th> <!-- Index instead of actual deliver_id -->
                            <th>Order ID</th>
                            <th>Total (₱)</th>
                            <th>Customer ID</th>
                            <th>Status</th>
...
`;
  ...
  `;
        ...
        // **Correctly closing table & wrapping divs**
        tableHTML += `
                    </tbody>
                </table>
...
<!-- Confirm Delivery Upload Section -->
<div class="container text-center mt-4">
    <div class="card p-4 shadow-lg border-0">
        <h4 class="mb-3">Confirm Delivery</h4>
        <input type="file" id="qrCodeInput" class="form-control mb-3" accept="image/*">
        <button id="uploadQRButton" class="btn btn-primary w-100">Confirm Delivery</button>
        <p id="deliveryStatus" class="mt-3 text-muted"></p>
    </div>
</div>
`;
